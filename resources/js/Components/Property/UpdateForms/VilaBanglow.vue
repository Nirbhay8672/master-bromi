<template>
    ...
    <div class="row gy-2">
        <div class="col">
            ...
            <label for="add_constructed_carpet_area" class="add-input-link ms-3 fw-bold">{{ other_details.add_constructed_carpet_area != 1 ? '+ Add' : '- Remove' }} Constructed Carpet Area</label>
            <input type="checkbox" value="1" id="add_constructed_carpet_area" class="d-none" v-model="other_details.add_constructed_carpet_area" @change="resetValue(['constructed_carpet_area', 'constructed_carpet_area_unit'])">

            <label for="add_constructed_builtup_area" class="add-input-link ms-3 fw-bold">{{ other_details.add_constructed_builtup_area != 1 ? '+ Add' : '- Remove' }} Constructed Builtup Area</label>
            <input type="checkbox" value="1" id="add_constructed_builtup_area" class="d-none" v-model="other_details.add_constructed_builtup_area" @change="resetValue(['constructed_builtup_area', 'constructed_builtup_area_unit'])">
        </div>
    </div>
