<template>
    ...
    <div class="row gy-2 mt-1">
        <div class="col-md-4" v-show="demoForm.add_terrace_carpet_area">
            <div class="input-group" >
                <div class="form-group col-md-7 m-b-20">
    ...
    <div class="row mt-3">
        <div class="row div_checkboxes1">
            ...
            <div class="form-check checkbox checkbox-solid-success mb-0 col-md-2">
                <input class="form-check-input" id="servant_room" type="checkbox" v-model="form.servant_room">
    ...
    <div class="row gy-2 mt-3">
        ...
        <div class="col-12 col-md-2">
            <div class="fname" :class="form.number_of_bathroom !== '' ? 'focused' : ''">
                <label for="number_of_bathroom">Number of Bathroom</label>
                <div class="fvalue">
                    <input class="form-control" type="text" value="" id="number_of_bathroom"
                        v-model="form.number_of_bathroom">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row div_checkboxes1">
            <div class="form-check checkbox checkbox-solid-success mb-0 col-md-2">
                <input class="form-check-input" id="is_have_amenities" value="true" type="checkbox"
                    v-model="demoForm.is_have_amenities" @change="() => form.amenities = amenities.reduce((acc, el) => ({ ...acc, [el.id]: false }), {})">
                <label class="form-check-label" for="is_have_amenities">Amenities</label>
            </div>
        </div>
    </div>

    <div v-if="demoForm.is_have_amenities" class="row mt-3">
        <b>Amenities</b>
